            ...
            <div class="col-12">
                <div class="caixa">
                    <span class="p-2 bg-title text-light text-uppercase  text-branco justify-content-space-between d-flex">
                        <span class="h5 mb-0 d-flex center-middle"><i class="far fa-list-alt mr-1"></i> Conta Pagar: <b
                                class="text-vermelho"> {{ $contapagar->id }}</b> </span>
                        <div class="d-flex">
                            @if (isset($contapagar->compra_id))
                                <a href="{{ route('compra.financeiro', $contapagar->compra_id) }}"
                                    class="btn btn-azul btn-pequeno ml-1" title="Voltar"><i class="fas fa-arrow-left"></i>
                                </a>
                            @else
                                <a href="{{ route('contapagar.index') }}" class="btn btn-azul btn-pequeno ml-1"
                ...
                <div class="col-12 mb-4">
                    <div class="caixa border radius-4">
                        <span class="p-2 bg-title text-light text-uppercase h4 mb-0 text-branco"><i
                                class="far fa-list-alt"></i> Dados da Conta a Pagar: {{ $contapagar->id }}</span>
                            ...
                            <div class="px-4">
                                <div class="rows pt-3 pb-4">
                                    ...
                                    <div class="col-3 mb-3">
                                        ...
                                        <input type="text" name="valor_a_pagar" readonly="readonly"
                                            id="valor_a_pagar" value="{{ $pagamento->valor_pago ?? null }}"
