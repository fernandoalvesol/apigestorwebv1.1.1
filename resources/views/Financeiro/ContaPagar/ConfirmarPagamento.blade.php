        ...
        <div class="col-12">
            <div class="caixa">
                <div class="p-2 text-uppercase justify-center d-flex">
                    <span class="h5 mb-0 d-flex center-middle bg-title">
                        ...
                        </svg> Confirmar Recebimento da Conta: <b class="text-vermelho ml-3"> {{ $contapagar->id }}</b>
                    </span>
                </div>
            </div>
            ...
            <div class="col-12 mb-4 mt-0">
                <fieldset class="caixa border radius-4 detalhes">
                    <legend class="h5"> Dados da Conta a Pagar: {{ $contapagar->id }} </legend>
                            ...
                            <div class="rows pt-0 pb-3">
                                ...
                                <div class="col-2 mb-3">
                                    ...
                                    <input type="date" name="data_vencimento" readonly="readonly"
                                        value="{{ $contapagar->data_vencimento }}" readonly id="data_vencimento"
                                        class="form-campo">
                                </div>
                                <div class="col-2 mb-3">
                                    <label class="text-label">Valor Original</label>
                                    <input type="text" readonly="readonly" readonly="readonly"
                                        value="{{ $contapagar->valor }}" class="form-campo mascara-float">
                                </div>

                                <div class="col-2 mb-3">
                                    <label class="text-label">Total Juros</label>
                                    <input type="text" readonly="readonly" readonly="readonly"
                                        value="{{ $contapagar->total_juros }}" class="form-campo mascara-float">
                                </div>

                                <div class="col-2 mb-3">
                                    <label class="text-label">Total Multa</label>
                                    <input type="text" readonly="readonly" readonly="readonly"
                                        value="{{ $contapagar->total_multa }}" class="form-campo mascara-float">
                                </div>

                                <div class="col-2 mb-3">
                                    <label class="text-label">Total Desconto</label>
                                    <input type="text" readonly="readonly" readonly="readonly"
                                        value="{{ $contapagar->total_desconto }}" class="form-campo mascara-float">
                                </div>

                                <div class="col-2 mb-3">
                                    <label class="text-label">Total Recebido</label>
                                    <input type="text" readonly="readonly" readonly="readonly"
                                        value="{{ $contapagar->total_recebido }}" class="form-campo mascara-float">
                                </div>

                                <div class="col-2 mb-3">
                                    <label class="text-label">Total Restante</label>
                                    <input type="text" readonly="readonly" readonly="readonly"
                                        value="{{ $contapagar->total_restante }}" class="form-campo mascara-float">
                                </div>
            ...
            <form action="{{ route('contapagar.pagar') }}" method="post">
                @csrf
                <div class="col-12 mb-4">
                    <input type="hidden" name="tipo_documento"
                        value="{{ $contapagar->venda_id ? config('constantes.tipo_documento.VENDA') : config('constantes.tipo_documento.AVULSO') }}">
                                ...
                                <div class="rows pb-1">
                                        ...
                                        <select name="conta_corrente_id" class="form-campo">
                                            @foreach ($contascorrentes as $conta)
                                                <option value="{{ $conta->id }}"
                                                    {{ $contapagar->conta_corrente_id == $conta->id ? 'selected' : '' }}>
                                    ...
                                    <div class="col-4">
                                        ...
                                        <select name="classificacao_financeira_id" class="form-campo">
                                            @foreach ($planocontas as $c)
                                                <option value="{{ $c->id }}"
                                                    {{ $contapagar->classificacao_financeira_id == $c->id ? 'selected' : '' }}>
                                    ...
                                    <div class="col-2 mb-3">
                                        ...
                                        <input type="text" name="valor_original" id="valor_original"
                                            onkeyup="atualizaValor()" required value="{{ $contapagar->total_restante }}"
                                            class="form-campo mascara-float">
                                    </div>

                                    <div class="col-2 mb-3">
                                        <label class="text-label">Valor Liquido</label>
                                        <input type="text" name="valor_liquido" required readonly id="valor_a_pagar"
                                            value="{{ $contapagar->total_restante }}" class="form-campo mascara-float">
                                    </div>
                                    <div class="col-2 mb-3">
