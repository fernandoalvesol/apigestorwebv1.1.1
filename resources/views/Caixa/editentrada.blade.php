    ...
    <div class="rows">
        <div class="col-12">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="col-md-6 titlefluxo">
                            <p>EDITAR LANÇAMENTO DE ENTRADA:</p>
                            <div class="editlancamento">
                            <p>Descrição: {{$caixas->descricao}}</p>
                            <p>Tipo: Entrada</p>
                        </div>
                    </div>
                </div> 
            ...
            <div class="caixaentradas">
                <form action="{{ route('caixa.update', $caixas->id) }}" class="form" method="POST">
                    @csrf
                    @method('PUT')
                    @include('Caixa._partials.formentradas')                    
                </form>               
            </div>
        </div>
    </div>
