<div class="menu-lateral">
    <a href="{{ route('home') }}" class="logo d-block" style="background:none">
        <img src="{{ asset('assets/img/logo-brasil.png') }}">
    </a>
    ...
    <nav class="menuprincipal" id="principal">
        <ul class="menu-ul icones">
            ...
            @if (view()->exists('inc.menu.menuImagem'))
                @include('inc.menu.menuImagem')
            @endif

            @if (view()->exists('inc.menu.menuComposicao'))
                @include('inc.menu.menuComposicao')
            @endif

            @if (view()->exists('inc.menu.menuGrade'))
                @include('inc.menu.menuGrade')
            @endif

            @if (view()->exists('inc.menu.menuEstoque'))
                @include('inc.menu.menuEstoque')
            @endif

            @if (view()->exists('inc.menu.menuNfe'))
                @include('inc.menu.menuNfe')
            @endif

            @if (view()->exists('inc.menu.menuImportacao'))
                @include('inc.menu.menuImportacao')
            @endif

            @if (view()->exists('inc.menu.menuManifesto'))
                @include('inc.menu.menuManifesto')
            @endif

            @if (view()->exists('inc.menu.menuFrenteLoja'))
                @include('inc.menu.menuFrenteLoja')
            @endif

            @if (view()->exists('inc.menu.menuVenda'))
                @include('inc.menu.menuVenda')
            @endif

            @if (view()->exists('inc.menu.menuCompra'))
                @include('inc.menu.menuCompra')
            @endif

            @if (view()->exists('inc.menuCaixa.menuCaixa'))
                @include('inc.menuCaixa.menuCaixa')
            @endif

            @if (view()->exists('inc.menu.menuFinanceiro'))
                @include('inc.menu.menuFinanceiro')
            @endif

            @if (view()->exists('inc.menu.menuMercadoPago'))
                @include('inc.menu.menuMercadoPago')
            @endif

            @if (view()->exists('inc.menu.menuEtiqueta'))
                @include('inc.menu.menuEtiqueta')
            @endif

            @if (view()->exists('inc.menu.menuUsuario'))
                @include('inc.menu.menuUsuario')
            @endif
        </ul>
    </nav>
