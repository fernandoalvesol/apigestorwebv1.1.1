            ...
            <div class="caixa">
                ...
                <div class="px-2 py-2 w-100 d-grid">
                    <div class="d-flex text-end">
                        <a href="{{ route('vendedor.create') }}" class="btn btn-roxo mx-1" title="Adicionar novo"><i
        ...
        <div class="col-12">
                        ...
                        <tbody>
                            @foreach ($lista as $l)
                                <tr>
                                    ...
                                    <td align="center">
                                        <a href="{{ route('vendedor.edit', $l->id) }}"
                                        ...
                                        <a href="javascript:;"
                                            ...
                                            <form action="{{ route('vendedor.destroy', $l->id) }}" method="POST"
                                                id="apagar{{ $l->id }}">
                                                @method('delete')
                                                @csrf
                                            </form>
            ...
            <!--
                                                                                                                                                                                <div class="caixa p-2">
                                                                                                                                                                                        ...
                                                                                                                                                                                        <p><b><i class="fas fa-check"></i> Mensagem de boas vindas</b> Parabéns seu vendedor foi inserido com sucesso</p>
                                                                                                                                                                                        </div>
