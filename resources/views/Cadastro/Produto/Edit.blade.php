                        ...
                        <div class="rows p-4">
                            <div class="col-4 d-flex">
                                <label class="py-1 px-2 mt-3 border text-center position-relative edit-upload">
                                    <img src="{{ asset($imagem) }}" class="img-fluido opaco" id="imgUp">
                            ...
                            <div class="col-8 px-2">
                                <div class="rows">
                                    ...
                                    <div class="col-4 mb-3">
                                        ...
                                        <input type="text" name="ncm" value="{{ old('ncm') ?? $produto->ncm }}"
                                            data-mask="0000.00.00" maxlength="10" class="form-campo" required>
                                    </div>
                                    <div class="col-4 mb-3">
                                        <label class="text-label">Código Barra/Gtin/EanTrib</label>
                                        <input type="text" name="gtin" value="{{ old('gtin') ?? $produto->gtin }}"
                                            class="form-campo">
                                    </div>
                                    <div class="col-4 mb-3">
                                        <label class="text-label">Cest</label>
                                        <input type="text" name="cest" value="{{ old('cest') ?? $produto->cest }}"
                                            class="form-campo">
                                    </div>
                                    ...
                                    <div class="col-6 mb-3">
                                        ...
                                        <div class="group-btn d-flex center-midlle">
                                            ...
                                            <a href="javascript:;" onclick="abrirModal('#modalCategoria')"
                                                class="text-azul p-1 border radius-50 ml-1 fas fa-plus"
                                        ...
                                        <select class="form-campo" name="unidade" required>
                                            @foreach ($unidades as $u)
                                                <option value="{{ $u->unidade }}"
                                                    {{ (old('unidade') ?? $produto->unidade) == $u->unidade ? 'selected' : '' }}>
                                                    {{ $u->unidade }}</option>
                                            @endforeach
                                    ...
                                    <div class="col-4 mb-3">
                                        ...
                                        <input type="text" readonly
                                            value="{{ old('estoque_inicial') ?? $produto->estoque_inicial }}"
                                    ...
                                    <div class="col mb-3">
                                        ...
                                        <input type="text" name="preco_custo"
                                            value="{{ old('preco_custo') ?? $produto->preco_custo }}" id="preco_custo"
                                    ...
                                    <div class="col mb-3">
                                        ...
                                        <input type="text" name="preco_venda"
                                            value="{{ old('preco_venda') ?? $produto->preco_venda }}" id="preco_venda"
