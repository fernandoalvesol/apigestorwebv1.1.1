                        ...
                        <tbody>
                            @foreach ($lista as $l)
                                <tr>
                                    ...
                                    <td align="left">{{ $l->unidade }}</td>
                                    <td align="left">{{ $l->abrev }}</td>
                                    <td align="center">
                                        <a href="{{ route('unidade.edit', $l->id) }}"
                                        ...
                                        <a href="javascript:;"
                                            ...
                                            <form action="{{ route('unidade.destroy', $l->id) }}" method="POST"
                                                id="apagar{{ $l->id }}" class="">
                                                @method('DELETE')
                                                @csrf
                                            </form>
