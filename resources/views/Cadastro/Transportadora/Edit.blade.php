                            ...
                            <div class="rows">
                                <div class="col-6 mb-3">
                                    ...
                                    <input type="text" name="razao_social" id="razao_social" required
                                        value="{{ old('razao_social') ?? $transportadora->razao_social }}"
                                        class="form-campo">
                                </div>
                                <div class="col-3 mb-3" id="divFantasia">
                                    <label class="text-label">Nome Fantasia</label>
                                    <input type="text" name="nome_fantasia" id="nome_fantasia"
                                        value="{{ old('nome_fantasia') ?? $transportadora->nome_fantasia }}"
                                ...
                                <div class="col-3 mb-3">
                                    ...
                                    <input type="text" name="cnpj" id="cnpj"
                                        value="{{ old('cnpj') ?? $transportadora->cnpj }}" class="form-campo">
                                </div>

                                <div class="col-3 mb-3">
                                    <label class="text-label">Celular:</label>
                                    <input type="text" name="celular"
                                        value="{{ old('celular') ?? $transportadora->celular }}"
                                ...
                                <div class="col-6 mb-3">
                                    ...
                                    <input type="email" name="email"
                                        value="{{ old('email') ?? $transportadora->email }}" class="form-campo">
                                </div>
                            ...
                            <div class="rows">
                                <div class="col-2 mb-3">
                                    ...
                                    <div class="input-grupo">
                                        <input type="text" value="{{ old('cep') ?? $transportadora->cep }}"
                                            name="cep" id="cep" class="form-campo busca_cep mascara-cep">
                                ...
                                <div class="col-6 mb-3">
                                    ...
                                    <input type="text" name="logradouro" id="logradouro"
                                        value="{{ old('logradouro') ?? $transportadora->logradouro }}"
                                        class="form-campo rua">
                                </div>
                                <div class="col-2 mb-4">
                                    <label class="text-label">Numero</label>
                                    <input type="text" name="numero" id="numero"
                                        value="{{ old('numero') ?? $transportadora->numero }}" class="form-campo ">
                                </div>
                                <div class="col-2 mb-2">
                                    <label class="text-label">UF</label>
                                    <input type="text" name="uf" id="uf"
                                        value="{{ old('uf') ?? $transportadora->uf }}" class="form-campo estado">
                                </div>
                                <div class="col-3 mb-3">
                                ...
                                <div class="col-3 mb-3">
                                    ...
                                    <input type="text" name="bairro" id="bairro"
                                        value="{{ old('bairro') ?? $transportadora->bairro }}"
                                ...
                                <div class="col-4 mb-2">
                                    ...
                                    <input type="text" name="cidade" id="cidade"
                                        value="{{ old('cidade') ?? $transportadora->cidade }}" class="form-campo cidade">
                                </div>
                                <div class="col-2 mb-2">
                                    <label class="text-label">IBGE</label>
                                    <input type="text" name="ibge" id="ibge"
                                        value="{{ old('ibge') ?? $transportadora->ibge }}" class="form-campo ibge">
                                </div>
                            </div>
                        </div>
                    </div>
