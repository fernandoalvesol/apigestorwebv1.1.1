        ...
        <div class="col-12">
            ...
            <div id="tab">
                ...
                <form action="{{ route('transportadora.store') }}" method="post">
                            ...
                            <div class="rows">
                                <div class="col-6 mb-3">
                                    ...
                                    <input type="text" name="razao_social" id="razao_social" required
                                        value="{{ old('razao_social') }}" class="form-campo">
                                </div>
                                ...
                                <div class="col-6 mb-3">
                                    ...
                                    <input type="text" name="email" value="{{ old('email') }}" class="form-campo">
                                </div>
                    ...
                    <div id="tab-2">
                        <div class="p-2">
                            <span class="d-block mt-1 mb-4 border-bottom text-uppercase pb-1">Endereço</span>
                            <div class="rows">
