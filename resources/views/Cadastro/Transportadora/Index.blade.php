            ...
            <div class="caixa">
                ...
                <div class="px-2 py-2 w-100 d-grid">
                    <div class="d-flex text-end">
                        <a href="{{ route('transportadora.create') }}" class="btn btn-roxo mx-1" title="Adicionar novo"><i
        ...
        <div class="col-12">
            ...
            <!--
                                                                                                                                                                            <div class="caixa p-2">
                                                                                                                                                                                    ...
                                                                                                                                                                                    <p><b><i class="fas fa-check"></i> Mensagem de boas vindas</b> Parabéns seu transportadora foi inserido com sucesso</p>
                                                                                                                                                                                    </div>
