        ...
        <div class="col-12">
            ...
            <div class="caixa">
                ...
                <div class="px-2 py-2 w-100 d-grid">
                    ...
                    @endif
                    @csrf
                    <div class="{{ isset($contacorrente->descricao) ? 'bg-edit' : 'caixafield' }}  p-2 radius-4 border">
                                ...
                                <div class="col-6">
                                    ...
                                    <select class="form-campo" name="banco_id">
                                        @foreach ($bancos as $banco)
                                            <option value='{{ $banco->id }}' required
                                                {{ ($contacorrente->banco_id ?? null) == $banco->id ? 'selected' : '' }}>
