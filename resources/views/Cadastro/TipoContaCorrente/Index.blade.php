        ...
        <div class="col-12">
            ...
            <div class="caixa">
                ...
                <div class="px-2 py-2 w-100 d-grid">
                    ...
                    @csrf
                    <div
                        class="{{ isset($tipocontacorrente->tipo_conta) ? 'bg-edit' : 'caixafield' }}  p-2 radius-4 border">
        ...
        <div class="col-12">
            <div class="px-2">
                <div class="tabela-responsiva pb-4">
                    <table cellpadding="0" cellspacing="0" id="dataTable" width="100%" class="table tipocontacorrente">
                        <thead>
                            <tr>
                        ...
                        <tbody>
                            @foreach ($lista as $l)
                                <tr>
                                    ...
                                    <td align="left">{{ $l->tipo_conta }}</td>
                                    <td align="center">
                                        <a href="{{ route('tipocontacorrente.edit', $l->id) }}"
                                        ...
                                        <a href="javascript:;"
                                            ...
                                            <form action="{{ route('tipocontacorrente.destroy', $l->id) }}" method="POST"
                                                id="apagar{{ $l->id }}">
                                                @method('DELETE')
                                                @csrf
                                            </form>
