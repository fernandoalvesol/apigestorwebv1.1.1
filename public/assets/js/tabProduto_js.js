...
$(function (){
    $("#btnInserirProduto").on("click", function(){
	 ...
	 $("#btnInserirProdutoSemCalculo").on("click", function(){
        ...
        $.ajax({
         url: base_url + "itemnotafiscal/inserirSemCalculo",
         type: "POST",
         data: {
             nfe_id:id_nfe,
			 natureza_operacao_id : natureza_operacao_id ,
...
function atualizarItens(){
	$.ajax({
         url: base_url + "itemnotafiscal/atualizar",
         type: "POST",
...
function atualizarSemCalculo(){
	$.ajax({
         url: base_url + "itemnotafiscal/atualizarSemCalculo",
         type: "POST",
...
function recalcular(){
	$.ajax({
         url: base_url + "itemnotafiscal/recalcular",
         type: "POST",
         data: $("#frmCadItemNfe").serialize() ,
         dataType:"Json",
         success: function(data){
...
function verDetalheItemNfe(id){
	 $.ajax({
         url: base_url + "itemnotafiscal/detalhe/" + id ,
         type: "GET",
         data: {  },
         dataType:"Json",
         success: function(data){
...
function excluirProdutoSemCalculo(id){
       $.ajax({
         url: base_url + "itemnotafiscal/excluirSemCalculo/" + id ,
         type: "GET",
         data: {  },
         dataType:"Json",
         success: function(data){
