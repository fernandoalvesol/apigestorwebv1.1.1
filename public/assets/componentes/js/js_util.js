function toggleHighlight() {
    var divElement = document.getElementById("minhaSenha");
...
function fecharGiraGira(eh_modal){
	if(eh_modal > 0){
		$(".fechar_giragira").hide();
	}else{
		fecharModal();
	}
}
...
function marcarCheck(nome, valor){
	if(valor=="S"){
		$('#'+nome).prop("checked", true);
	}else if(valor=="N"){
