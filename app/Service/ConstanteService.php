    ...
    public static function listaStatusVenda(){
        return Status::whereIn('id',
            [
                ...
                Config('constantes.status.DELETADO')
            ]
            )->get();
    }

    public static function listaStatusNfeEntrada(){
        return Status::whereIn('id',
            [
                Config('constantes.status.DIGITACAO'),
                Config('constantes.status.CONCRETIZADO')
  ...
  public static  function getUf($valor){
    ...
    public static function listaPadraoNatureza(){
        return [
            ...
            '3' => 'Padrão Pdv',
            '4' => 'Padrão Loja',
            '5' => 'Padrão Devolução de Venda (Entrada)',
            '6' => 'Padrão Devolução de Compra (Saída)'
        ];
    }
    ...
    public static function listaModalidadeSt(){
        return [
