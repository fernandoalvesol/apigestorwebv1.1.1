        ...
        <div class="col-12">
            ...
            <div class="caixa">
                ...
                <div class="px-2 py-2 w-100 d-grid">
                    <?php if(isset($despesafixa)): ?>
                        <form action="<?php echo e(route('despesafixa.update', $despesafixa->id)); ?>" method="POST">
                            <?php echo method_field('put'); ?>
                        <?php else: ?>
                            <form action="<?php echo e(route('despesafixa.store')); ?>" method="POST">
                    <?php endif; ?>
                    <?php echo csrf_field(); ?>
                    <div class="<?php echo e(isset($despesafixa->descricao) ? 'bg-edit' : 'caixafield'); ?>  p-2 radius-4 border">
                            ...
                            <div class="rows center-middle">
                                <div class="col-3">
                                    ...
                                    <select id="plano_conta_id" name="plano_conta_id" class="form-campo">
                                        ...
                                        <?php $__currentLoopData = $planos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $conta): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($conta->id); ?>"><?php echo e($conta->codigo); ?> - <?php echo e($conta->conta); ?>
                                ...
                                <div class="col-3">
                                    ...
                                    <select id="fornecedor_id" name="fornecedor_id" class="form-campo">
                                        ...
                                        <?php $__currentLoopData = $fornecedores; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $f): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($f->id); ?>"><?php echo e($f->id); ?> - <?php echo e($f->razao_social); ?>
                                ...
                                <div class="col-3">
                                    ...
                                    <select id="centro_custo_id" name="centro_custo_id" class="form-campo">
                                        ...
                                        <?php $__currentLoopData = $centros; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($c->id); ?>"><?php echo e($c->id); ?> - <?php echo e($c->nome); ?>
                                ...
                                <div class="col-3">
                                    ...
                                    <select id="conta_corrente_id" name="conta_corrente_id" class="form-campo">
                                        <option value="">Selecione</option>
                                        <?php $__currentLoopData = $contas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $co): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($co->id); ?>"><?php echo e($co->id); ?> -
                                                <?php echo e($co->descricao); ?>
                                ...
                                <div class="col-3">
                                    ...
                                    <select id="forma_pagto_id" name="forma_pagto_id" class="form-campo">
                                        <option value="">Selecione</option>
                                        <?php $__currentLoopData = $formas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $fo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($fo->id); ?>"><?php echo e($fo->id); ?> -
                                                <?php echo e($fo->forma_pagto); ?>
                                ...
                                <div class="col-3">
                                    ...
                                    <input type="text" name="descricao" required
                                        value="<?php echo e($despesafixa->descricao ?? old('descricao')); ?>" class="form-campo">
                                </div>
                                <div class="col-2">
                                    <label class="text-label d-block text-branco">Dia Vcto </label>
                                    <input type="number" name="dia_vencimento" required
                                        value="<?php echo e($despesafixa->dia_vencimento ?? old('dia_vencimento')); ?>"
                                        class="form-campo">
                                </div>
                                <div class="col-2">
                                    <label class="text-label d-block text-branco">Valor </label>
                                    <input type="text" name="valor" value="<?php echo e($despesafixa->valor ?? old('valor')); ?>"
                        ...
                        <tbody>
                            <?php $__currentLoopData = $lista; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $l): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td align="left"><?php echo e($l->descricao); ?></td>
                                    <td align="left"><?php echo e($l->dia_vencimento); ?></td>
                                    <td align="left"><?php echo e($l->valor); ?></td>
                                    <td align="left"><?php echo e($l->planoconta->conta ?? null); ?></td>
                                    <td align="left"><?php echo e($l->forma_pagto->forma_pagto ?? null); ?></td>
                                    <td align="center">
                                        <a href="<?php echo e(route('despesafixa.edit', $l->id)); ?>"
                                        ...
                                        <a href="javascript:;"
                                            ...
                                            <form action="<?php echo e(route('despesafixa.destroy', $l->id)); ?>" method="POST"
...
<?php echo $__env->make('template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/resources/views/Financeiro/DespesaFixa/Index.blade.php ENDPATH**/ ?>