<div class="menu-lateral">
    <a href="<?php echo e(route('home')); ?>" class="logo d-block" style="background:none">
        <img src="<?php echo e(asset('assets/img/logomin-zeus.svg')); ?>">
    </a>
            ...
            <li class="submenu">
                ...
                <ul>
                    <li class="subcat">
                        ...
                        <ul>
                            <li><a href="<?php echo e(route('categoria.index')); ?>">Categoria</a></li>
                            <li><a href="<?php echo e(route('unidade.index')); ?>">Unidade</a></li>
                            <li><a href="<?php echo e(route('banco.index')); ?>">Banco</a></li>
                            <li><a href="<?php echo e(route('tipocontacorrente.index')); ?>">Tipo Conta Corrente</a></li>
                            <li><a href="<?php echo e(route('status.index')); ?>">Status</a></li>
                            <li><a href="<?php echo e(route('formapagto.index')); ?>">Forma Pagto</a></li>
                        </ul>
                    </li>
                    <li class="subcat">
                        <a href="">Produto</a>
                        <ul>
                            <li><a href="<?php echo e(route('produto.index')); ?>">Lista de produto</a></li>
                            <li><a href="<?php echo e(route('produto.create')); ?>">Cadastro de produto</a></li>
                        </ul>
                    </li>
                    <li class="subcat">
                        <a href="">Cliente</a>
                        <ul>
                            <li><a href="<?php echo e(route('cliente.index')); ?>">Lista de Cliente</a></li>
                            <li><a href="<?php echo e(route('cliente.create')); ?>">Cadastro de Cliente</a></li>
                        </ul>
                    </li>
                    <li class="subcat">
                        <a href="">Fornecedor</a>
                        <ul>
                            <li><a href="<?php echo e(route('fornecedor.index')); ?>">Lista de Fornecedor</a></li>
                            <li><a href="<?php echo e(route('fornecedor.create')); ?>">Cadastro de Fornecedor</a></li>
                        </ul>
                    </li>
                    <li class="subcat">
                        <a href="">Transportadora</a>
                        <ul>
                            <li><a href="<?php echo e(route('transportadora.index')); ?>">Lista de Tranpostadora</a></li>
                            <li><a href="<?php echo e(route('transportadora.create')); ?>">Cadastro de Transportadora</a></li>
                        </ul>
                    </li>
                    <li class="subcat">
                        <a href="">Vendedor</a>
                        <ul>
                            <li><a href="<?php echo e(route('vendedor.index')); ?>">Lista</a></li>
                            <li><a href="<?php echo e(route('vendedor.create')); ?>">Cadastro de Vendedor</a></li>
                        </ul>
                    </li>
                    ...
                    <li class="subcat">
                        ...
                        <ul>
                            <li><a href="<?php echo e(route('contacorrente.index')); ?>">Lista de Conta Corrente</a></li>
                        </ul>
                    </li>
                </ul>
            </li>
...
<?php /**PATH /var/www/appgestorweb/resources/views/menu.blade.php ENDPATH**/ ?>