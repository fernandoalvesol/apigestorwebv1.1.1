            ...
            <div class="caixa">
                ...
                <div class="px-2 py-2 w-100 d-grid">
                    <?php if(isset($unidade)): ?>
                        <form action="<?php echo e(route('unidade.update', $unidade->id)); ?>" method="POST">
                            <?php echo method_field('put'); ?>
                        <?php else: ?>
                            <form action="<?php echo e(route('unidade.store')); ?>" method="POST">
                    <?php endif; ?>
                    <?php echo csrf_field(); ?>
                    <div class="<?php echo e(isset($unidade->unidade) ? 'bg-edit' : 'caixafield'); ?>  p-2 radius-4 border">
                        <div class="   p-2 pt-0 radius-4">
                            <div class="rows center-middle">
                                <div class="col-6">
                                    <label class="text-label d-block text-branco">Nome </label>
                                    <input type="text" name="unidade" value="<?php echo e($unidade->unidade ?? old('abrev')); ?>"
                                        class="form-campo">
                                </div>
                                <div class="col-3">
                                    <label class="text-label d-block text-branco">Abrev </label>
                                    <input type="text" name="abrev" value="<?php echo e($unidade->abrev ?? old('unidade')); ?>"
                                        class="form-campo">
                                </div>
        ...
        <div class="col-12">
            <div class="px-2">
                <div class="tabela-responsiva pb-4">
                    <table cellpadding="0" cellspacing="0" id="dataTable" width="100%" class="table unidade">
                        <thead>
                            <tr>
                                <th align="center">Id</th>
                                <th align="left" width="50%">Nome</th>
                                <th align="left">Abrev</th>
                        ...
                        <tbody>
                            <?php $__currentLoopData = $lista; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $l): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td align="left"><?php echo e($l->unidade); ?></td>
                                    <td align="left"><?php echo e($l->abrev); ?></td>
                                    <td align="center">
                                        <a href="<?php echo e(route('unidade.edit', $l->id)); ?>"
                                        ...
                                        <a href="javascript:;"
                                            ...
                                            <form action="<?php echo e(route('unidade.destroy', $l->id)); ?>" method="POST"
                                                id="apagar<?php echo e($l->id); ?>" class="">
...
<?php echo $__env->make('template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/resources/views/Cadastro/Unidade/Index.blade.php ENDPATH**/ ?>