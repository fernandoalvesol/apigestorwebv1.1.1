        ...
        <div class="col-12">
            ...
            <div class="caixa">
                ...
                <div class="px-2 py-2 w-100 d-grid">
                    ...
                    <?php endif; ?>
                    <?php echo csrf_field(); ?>
                    <div class="<?php echo e(isset($categoria->categoria) ? 'bg-edit' : 'caixafield'); ?>  p-2 radius-4 border">
                        <div class="   p-2 pt-0 radius-4">
                            <div class="rows center-middle">
                                <div class="col-9">
                                    <label class="text-label d-block text-branco">Nome </label>
                                    <input type="text" name="categoria"
                                        value="<?php echo e($categoria->categoria ?? old('categoria')); ?>" class="form-campo">
                                </div>
                        ...
                        <tbody>
                            <?php $__currentLoopData = $lista; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $l): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td align="left"><?php echo e($l->categoria); ?></td>
                                    <td align="center">
                                        <a href="<?php echo e(route('categoria.edit', $l->id)); ?>"
                                        ...
                                        <a href="javascript:;"
                                            ...
                                            <form action="<?php echo e(route('categoria.destroy', $l->id)); ?>" method="POST"
...
<?php echo $__env->make('template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/resources/views/Cadastro/Categoria/Index.blade.php ENDPATH**/ ?>