...
<?php $__env->startSection('conteudo'); ?>
                ...
                <div class="rows p-4">
                    <div class="col-4 d-flex">
                        <label class="py-1 px-2 mt-3 border text-center position-relative edit-upload">
                            <img src="<?php echo e(asset('assets/img/semproduto.png')); ?>" class="img-fluido opaco" id="imgUp">
                    ...
                    <div class="col-8 px-2">
                        <div class="rows">
                            <div class="col-12 mb-3">
                                ...
                                <input type="text" name="nome" value="<?php echo e(old('nome')); ?>" class="form-campo"
                                    required>
                            </div>
                            <div class="col-4 mb-3">
                                <label class="text-label">NCM</label>
                                <input type="text" name="ncm" value="<?php echo e(old('ncm')); ?>" data-mask="0000.00.00"
                                    maxlength="10" class="form-campo" required>
                            </div>
                            <div class="col-4 mb-3">
                                <label class="text-label">Código Barra/Gtin/EanTrib</label>
                                <input type="text" name="gtin" value="<?php echo e(old('gtin')); ?>" class="form-campo">
                            </div>
                            <div class="col-4 mb-3">
                                <label class="text-label">Cest</label>
                                <input type="text" name="cest" value="<?php echo e(old('cest')); ?>" class="form-campo">
                            </div>

                            <div class="col-6 mb-3">
                                <label class="text-label">Origem</label>
                                <select class="form-campo" name="origem">
                                    <?php $__currentLoopData = ConstanteService::listaOrigem(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $chave => $valor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($chave); ?>"><?php echo e($valor); ?> </option>
                                ...
                                <div class="group-btn d-flex center-midlle">
                                    <select class="form-campo" name="categoria_id" id="cb_categoria_id">
                                        <?php $__currentLoopData = $categorias; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($cat->id); ?>"><?php echo e($cat->categoria); ?> </option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                            ...
                            <div class="col-4 mb-3">
                                ...
                                <select class="form-campo" name="unidade" required>
                                    <?php $__currentLoopData = $unidades; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $u): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($u->unidade); ?>"> <?php echo e($u->unidade); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <div class="col-4 mb-3">
                                ...
                                <input type="text" name="estoque_inicial" value="<?php echo e(old('estoque_inicial')); ?>"
                                    class="form-campo mascara-float">
                            </div>
                            <div class="col-4 mb-3">
                                <label class="text-label">Estoque Máximo</label>
                                <input type="text" name="estoque_maximo" value="<?php echo e(old('estoque_maximo')); ?>"
                                    class="form-campo mascara-float">
                            </div>

                            <div class="col mb-3">
                                <label class="text-label">Estoque Minimo</label>
                                <input type="text" name="estoque_minimo" value="<?php echo e(old('estoque_minimo')); ?>"
                                    class="form-campo mascara-float">
                            </div>
                            <div class="col mb-3">
                                <label class="text-label">Preço Custo</label>
                                <input type="text" name="preco_custo" value="<?php echo e(old('preco_custo')); ?>" id="preco_custo"
                                    onkeyup="calcularPreco()" class="form-campo mascara-float">
                            </div>

                            <div class="col mb-3">
                                <label class="text-label">(%) Margem Lucro</label>
                                <input type="text" name="margem_lucro" value="<?php echo e(old('margem_lucro')); ?>"
                                    onkeyup="calcularPreco()" id="margem_lucro" class="form-campo mascara-float">
                            </div>

                            <div class="col mb-3">
                                <label class="text-label">Preço Venda</label>
                                <input type="text" name="preco_venda" value="<?php echo e(old('preco_venda')); ?>"
    ...
    <?php echo $__env->make('Cadastro.Categoria.modalCategoria', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/resources/views/Cadastro/Produto/Create.blade.php ENDPATH**/ ?>