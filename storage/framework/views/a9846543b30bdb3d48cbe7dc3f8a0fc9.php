        ...
        <div class="col-12">
            ...
            <div class="caixa">
                ...
                <div class="px-2 py-2 w-100 d-grid">
                    <?php if(isset($banco)): ?>
                        <form action="<?php echo e(route('banco.update', $banco->id)); ?>" method="POST">
                            <?php echo method_field('put'); ?>
                        <?php else: ?>
                            <form action="<?php echo e(route('banco.store')); ?>" method="POST">
                    <?php endif; ?>
                    <?php echo csrf_field(); ?>
                    <div class="<?php echo e(isset($banco->banco) ? 'bg-edit' : 'caixafield'); ?>  p-2 radius-4 border">
                        <div class="   p-2 pt-0 radius-4">
                            <div class="rows center-middle">
                                <div class="col-3">
                                    <label class="text-label d-block text-branco">Codigo </label>
                                    <input type="text" name="codigo" value="<?php echo e($banco->codigo ?? old('cod')); ?>"
                                        class="form-campo">
                                </div>
                                <div class="col-6">
                                    <label class="text-label d-block text-branco">Nome </label>
                                    <input type="text" name="banco" value="<?php echo e($banco->banco ?? old('banco')); ?>"
                                        class="form-campo">
                                </div>
                        ...
                        <tbody>
                            <?php $__currentLoopData = $lista; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $l): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td align="left"><?php echo e($l->codigo); ?></td>
                                    <td align="left"><?php echo e($l->banco); ?></td>
                                    <td align="center">
                                        <a href="<?php echo e(route('banco.edit', $l->id)); ?>"
                                        ...
                                        <a href="javascript:;"
                                            ...
                                            <form action="<?php echo e(route('banco.destroy', $l->id)); ?>" method="POST"
...
<?php echo $__env->make('template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/resources/views/Cadastro/Banco/Index.blade.php ENDPATH**/ ?>