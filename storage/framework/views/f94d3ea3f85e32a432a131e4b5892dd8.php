            ...
            <div class="caixa">
                ...
                <div class="px-2 py-2 w-100 d-grid">
                    <?php if(isset($centrocusto)): ?>
                        <form action="<?php echo e(route('centrocusto.update', $centrocusto->id)); ?>" method="POST">
                            <?php echo method_field('put'); ?>
                        <?php else: ?>
                            <form action="<?php echo e(route('centrocusto.store')); ?>" method="POST">
                    <?php endif; ?>
                    <?php echo csrf_field(); ?>
                    <div class="<?php echo e(isset($centrocusto->nome) ? 'bg-edit' : 'caixafield'); ?>  p-2 radius-4 border">
                        <div class="   p-2 pt-0 radius-4">
                            <div class="rows center-middle">
                                <div class="col-9">
                                    <label class="text-label d-block text-branco">Nome </label>
                                    <input type="text" name="nome" value="<?php echo e($centrocusto->nome ?? old('nome')); ?>"
                                        class="form-campo">
                                </div>
        ...
        <div class="col-12">
            <div class="px-2">
                <div class="tabela-responsiva pb-4">
                    <table cellpadding="0" cellspacing="0" id="dataTable" width="100%" class="table centrocusto">
                        <thead>
                            <tr>
                        ...
                        <tbody>
                            <?php $__currentLoopData = $lista; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $l): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td align="center">
                                        <a href="<?php echo e(route('centrocusto.edit', $l->id)); ?>"
                                        ...
                                        <a href="javascript:;"
                                            ...
                                            <form action="<?php echo e(route('centrocusto.destroy', $l->id)); ?>" method="POST"
...
<?php echo $__env->make('template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/resources/views/Financeiro/CentroCusto/Index.blade.php ENDPATH**/ ?>