            ...
            <span class=" bg-title text-light text-uppercase h5 mb-0 text-branco">
                ...
                <div class="row col-md-12">
                    <div class="col-md-6 pesquisarform">
                            <form action="<?php echo e(route('caixa.search')); ?>" method="POST" class="form form-inline">
                                <?php echo csrf_field(); ?>
                    ...
                    <div class="col-md-6 pesquisar">
                            <form action="<?php echo e(route('caixa.pesquisar')); ?>" method="POST" class="form form-inline">
                                <?php echo csrf_field(); ?>
                        ...
                        <tbody>
                            <?php $__empty_1 = true; $__currentLoopData = $caixas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $caixa): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr>
                                    ...
                                    <td style="width=10px;">
                                        <a href="<?php echo e(route('caixa.edit', $caixa->id)); ?>" class="btn btn-editar"><i class="far fa-edit"></i>Editar</a>
                                        <a href="<?php echo e(route('caixa.delete', $caixa->id)); ?>" class="btn btn-deletar"><i class="fas fa-trash-alt"></i>Deletar</a>
                                    </td>        
                                </tr>
...
<?php echo $__env->make('template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/resources/views/Caixa/caixa.blade.php ENDPATH**/ ?>