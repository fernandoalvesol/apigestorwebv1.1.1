            ...
            <div class="col-12">
                ...
                <div class="px-2 py-2 w-100 d-grid">
                    <div class="d-flex text-end">
                        <a href="<?php echo e(route('contapagar.create')); ?>" class="btn btn-azul d-inline-block"
                            ...
                            <div class=" bg-padrao mt-0 p-2 radius-4">
                                <div class="rows">
                                    <div class="col-3 mb-2">
                                        ...
                                        <input type="date" name="venc01" value="<?php echo e($filtro->venc01 ?? ''); ?>"
                                            class="form-campo">
                                    </div>
                                    <div class="col-3 mb-2">
                                        <label class="text-label d-block text-branco">Vencimento 02 </label>
                                        <input type="date" name="venc02" value="<?php echo e($filtro->venc02 ?? ''); ?>"
                                            class="form-campo">
                                    </div>
                                    <div class="col-3 mb-2">
                                        <label class="text-label d-block text-branco">Emissão 01 </label>
                                        <input type="date" name="emissao01" value="<?php echo e($filtro->emissao01 ?? ''); ?>"
                                            class="form-campo">
                                    </div>
                                    <div class="col-3 mb-2">
                                        <label class="text-label d-block text-branco">Emissão 02 </label>
                                        <input type="date" name="emissao02" value="<?php echo e($filtro->emissao02 ?? ''); ?>"
                                            class="form-campo">
                                    </div>
                                    <?php
                                        ...
                                        <select name="fornecedor_id" class="form-campo">
                                            ...
                                            <?php $__currentLoopData = $fornecedores; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $f): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($f->id); ?>"
                                                    <?php echo e($id_fornecedor == $f->id ? 'selected' : ''); ?>><?php echo e($f->razao_social); ?>
                                    ...
                                    <div class="col-4 mb-3">
                                        ...
                                        <div class="check d-flex">
                                            <label class=" d-flex text-branco text-uppercase"><input type="checkbox"
                                                    ...
                                                    value="<?php echo e(config('constantes.status.ABERTO')); ?>"
                                                    <?php echo e(in_array(config('constantes.status.ABERTO'), $filtro->status_id) ? 'checked' : ''); ?>>
                                                ABERTO</label>
                                            <label class="ml-2 d-flex text-branco text-uppercase text-uppercase ml-6"><input
                                                    type="checkbox" class="mr-1" name="status_id[]"
                                                    value="<?php echo e(config('constantes.status.PARCIALMENTE_PAGO')); ?>"
                                                    <?php echo e(in_array(config('constantes.status.PARCIALMENTE_PAGO'), $filtro->status_id) ? 'checked' : ''); ?>>
                                                PARCIALMENTE PAGO</label>
                                            <label class="ml-2 d-flex text-branco text-uppercase text-uppercase ml-6"><input
                                                    type="checkbox" class="mr-1" name="status_id[]"
                                                    value="<?php echo e(config('constantes.status.PAGO')); ?>"
                                                    <?php echo e(in_array(config('constantes.status.PAGO'), $filtro->status_id) ? 'checked' : ''); ?>>
                                                PAGO</label>
                                    ...
                                    <div class="col-2 mb-2">
                                        ...
                                        <div class="check d-flex">
                                            <label class="text-branco text-uppercase d-flex"><input type="checkbox"
                                                    ...
                                                    <?php echo e($filtro->mostrar_pagto == 'S' ? 'checked' : ''); ?>> Mostrar
                                                Pagto</label>
                                        </div>
                                    </div>
                                ...
                                <?php $__currentLoopData = $lista; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lancamento): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <tr class="thead">
                                        ...
                                        <td align="left"><?php echo e($lancamento->descricao); ?> <small
                                                class="d-block text-azul"><?php echo e($lancamento->fornecedor->razao_social ?? 'Sistema'); ?>
                                        ...
                                        <td align="center"><?php echo e(formataNumeroBr($lancamento->valor)); ?></td>
                                        <td align="center"><?php echo e($lancamento->fornecedor->razao_social ?? 'Sistema'); ?></td>
                                        <td align="center"><span
                                                class="<?php echo e(strtolower($lancamento->status->status)); ?>"><?php echo e($lancamento->status->status); ?></span>
                                        </td>

                                        <td align="center">
                                            <a href="<?php echo e(route('contapagar.confirmarPagamento', $lancamento->id)); ?>"
                                        ...
                                        <?php if(count($lancamento->pagamentos) > 0): ?>
                                            <?php if($filtro->mostrar_pagto == 'S'): ?>
                                    <tr class="thead">
                                        <td colspan="8" class="" align="center">
                                            <table cellpadding="0" cellspacing="0"
                                                ...
                                                <tbody>
                                                    ...
                                                    <?php $__currentLoopData = $lancamento->pagamentos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pag): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <tr>
                                                            <td align="center"><?php echo e($pag->id); ?></td>
                                                            <td align="left"><?php echo e($pag->descricao_pagamento); ?> </td>
                                                            <td align="center"><?php echo e(databr($pag->data_pagamento)); ?></td>
                                                            <td align="center"><?php echo e($pag->numero_documento); ?></td>
                                                            <td align="center"><?php echo e(formataNumeroBr($pag->valor_original)); ?>

                                                            </td>
                                                            <td align="center"><?php echo e(formataNumeroBr($pag->juros)); ?></td>
                                                            <td align="center"><?php echo e(formataNumeroBr($pag->desconto)); ?></td>
                                                            <td align="center"><?php echo e(formataNumeroBr($pag->multa)); ?></td>
                                                            <td align="center"><?php echo e(formataNumeroBr($pag->valor_pago)); ?>

                                                            </td>
                                                            <td align="center"><?php echo e($pag->forma_pagto->forma_pagto); ?></td>
                                                            <td align="center">
                                                                <a href="<?php echo e(route('pagamento.show', $pag->id)); ?>"
...
<?php echo $__env->make('template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/resources/views/Financeiro/ContaPagar/Index.blade.php ENDPATH**/ ?>