<li class="submenu">
                ...
                <ul>
                    <li class="subcat">
                        <a href="<?php echo e(route('caixa.index')); ?>">Fluxo de Caixa</a>                       
                    </li>

                    <li class="subcat">
                        <a href="<?php echo e(route('entrada.index')); ?>">Entradas</a>                        
                    </li>
            ...
            </li><?php /**PATH /var/www/resources/views/inc/menuCaixa/menuCaixa.blade.php ENDPATH**/ ?>