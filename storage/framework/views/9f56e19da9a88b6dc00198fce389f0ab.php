            ...
            <div class="caixa">
                ...
                <div class="px-2 py-2 w-100 d-grid">
                    <div class="d-flex text-end">
                        <a href="<?php echo e(route('cliente.create')); ?>" class="btn btn-roxo mx-1" title="Adicionar novo"><i
                        ...
                        <div class="mostraFiltro bg-padrao mt-2 p-2 radius-4 border">
                            <div class="rows center-middle">
                                ...
                                <div class="col-3">
                                    ...
                                    <input type="text" name="email" value="<?php echo e($filtro->email ?? null); ?>"
                                        class="form-campo" placeholder="Digite aqui..">
                                </div>
                                <div class="col-3">
                                    <label class="text-label d-block text-branco">CPF </label>
                                    <input type="text" name="cpf" value="<?php echo e($filtro->cpf ?? null); ?>"
                                        class="form-campo" placeholder="Digite aqui..">
                                </div>
                        ...
                        <tbody>
                            <?php $__currentLoopData = $lista; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $l): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td align="left"><?php echo e($l->nome_razao_social); ?></td>
                                    <td align="left"><?php echo e($l->cpf_cnpj); ?></td>
                                    <td align="center"><?php echo e($l->email); ?></td>
                                    <td align="center"><?php echo e($l->celular); ?></td>
                                    <td align="center">
                                        <a href="<?php echo e(route('cliente.edit', $l->id)); ?>"
                                        ...
                                        <a href="javascript:;"
                                            ...
                                            <form action="<?php echo e(route('cliente.destroy', $l->id)); ?>" method="POST"
...
<?php echo $__env->make('template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/resources/views/Cadastro/Cliente/Index.blade.php ENDPATH**/ ?>